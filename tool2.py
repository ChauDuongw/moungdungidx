...
async def open_single_tab_with_actions(browser, tab_id: int):
    ...
    try:
        ...
        await page.locator("#chat-input-box").fill("a", timeout=30000)
        ...
        await page.locator("#workbench-frame").content_frame.get_by_role("menuitem", name="Application Menu").locator("div").click(timeout=60000)
        message_queue.put((tab_id, "Đang nhấn Ctrl+Shift+C..."))
        await page.keyboard.press("Control+Shift+C", delay=1)
        message_queue.put((tab_id, "Đã nhấn Ctrl+Shift+C."))
        message_queue.put((tab_id, "Đang delay.")) 
